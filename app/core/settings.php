...
if (file_exists($projectRoot . '/.env')) {
    $envFile = @file($projectRoot . '/.env', FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
    if ($envFile) {
...
// CONFIGURACIÓN DE ARCHIVOS (rutas relativas a raíz del proyecto)
...
if (DEV_MODE) {
    ...
    ini_set('error_log', $projectRoot . '/debug.log');
} else {
